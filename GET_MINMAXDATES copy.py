# sstubs_csv = '/Users/eliaeiroa/Desktop/SPRING21/RESEARCH/MSR_2021/MSR2021/PAPER_EXTENSION/NEW_ALGO/FINAL_SCRIPTS_ACTUALLY/FINAL_SSTUBS_ALLINFO.csv'
# commits_out_file = '/Users/eliaeiroa/Desktop/SPRING21/RESEARCH/MSR_2021/MSR2021/PAPER_EXTENSION/NEW_ALGO/FINAL_SCRIPTS_ACTUALLY/sstubsCommitsperProject.json'
# minmaxdates_out_file = '/Users/eliaeiroa/Desktop/SPRING21/RESEARCH/MSR_2021/MSR2021/PAPER_EXTENSION/NEW_ALGO/FINAL_SCRIPTS_ACTUALLY/minMaxDaresPerProject.json'

# minmaxdates_out_file = '/home/elia/SSTUBS_PAPER/results/minMaxDaresPerProject.json'
import os
...
def write_to_csv(writeThis, filename ='/home/elia/SSTUBS_PAPER/results/problematic_commits.csv', mode = 'a'):
# def write_to_csv(writeThis, filename ='/Users/eliaeiroa/Desktop/SPRING21/RESEARCH/MSR_2021/MSR2021/PAPER_EXTENSION/NEW_ALGO/projects/problematic_commits_DEBUGGED.csv', mode = 'a'):
...
# def write_to_json(writeThis, filename = '/Users/eliaeiroa/Desktop/SPRING21/RESEARCH/MSR_2021/MSR2021/PAPER_EXTENSION/NEW_ALGO/projects/FINAL_SSTUBS_DEBUGGED_TEST.json', mode = 'a'):
...
# dir = "projects"
# parentDir = "/home/elia/SSTUBS_PAPER" projectFolder
def get_auth_count(beforeDate, afterDate,projectFolder):
    ...
    path = '/home/elia/SSTUBS_PAPER/projects/'+projectFolder+'/gitcommitters.txt'
    ...
    path1 = '/home/elia/SSTUBS_PAPER/projects/'+projectFolder+'/gitauthors.txt'
    print(git_authors)
    try:
...
# def get_min_max_dates(sstubs = r'/home/elia/SSTUBS_PAPER/FINAL_SSTUBS_DEBUGGED_FORCSV.json'):
...
# projectnames_file = '/home/elia/SSTUBS_PAPER/project_names_dict.json'
# sftp://elia@192.168.200.36/home/elia/SSTUBS_PAPER/results/FINAL_SSTUBS_DEBUGGED_FORCSV.json
sstubs_csv_in = '/home/elia/SSTUBS_PAPER/FINAL_SSTUBS_ALLINFO.json'
# sftp://elia@192.168.200.36/home/elia/SSTUBS_PAPER/FINAL_SSTUBS_ALLINFO.json
sstubs_csv_out = '/home/elia/SSTUBS_PAPER/results/04_12_18h38/FINAL_SSTUBS_DEBUGGED_CSV.csv'
# sftp://elia@192.168.200.36/home/elia/SSTUBS_PAPER/results/04_12_18h38/FINAL_SSTUBS_DEBUGGED_CSV.csv
# sftp://elia@192.168.200.36/home/elia/SSTUBS_PAPER/results/results_from_first_run/FINAL_SSTUBS_DEBUGGED_FORCSV.json
commits_out_file = '/home/elia/SSTUBS_PAPER/results/sstubsCommitsperProject_new.json'
minmaxdates_out_file = '/home/elia/SSTUBS_PAPER/results/minMaxDaresPerProject_new.json'
# generateFinalJSON(sstubs_file, sstubs_csv)
project_names_dict_fn = '/home/elia/SSTUBS_PAPER/results/project_names_dict.json'
# sstubsLarge_fn = '/home/elia/SSTUBS_PAPER/sstubsLarge.json'
...
for project, dates in dates_per_project.items():
    ...
    write_to_csv(stats, filename ='/home/elia/SSTUBS_PAPER/results/basicInfoPerProject_saveProg.csv', mode = 'a')
    # write_to_json(project_info[project], filename = '/home/elia/SSTUBS_PAPER/results/basicInfoPerProject_saveProg.json', mode = 'a')
    # write_to_json(author_stats[project], filename = '/home/elia/SSTUBS_PAPER/results/authorStatsPerProject_saveProg.json', mode = 'a')
    # write_to_json(committer_stats[project], filename = '/home/elia/SSTUBS_PAPER/results/committerStatsPerProject_saveProg.json', mode = 'a')
    os.chdir(filePath)
write_to_csv(project_info, filename ='/home/elia/SSTUBS_PAPER/results/basicInfoPerProject_fin.csv', mode = 'w')
# write_to_json(author_stats, filename = '/home/elia/SSTUBS_PAPER/results/authorStatsPerProject_fin.json', mode = 'w')
# write_to_json(committer_stats, filename = '/home/elia/SSTUBS_PAPER/results/committerStatsPerProject_fin.json', mode = 'w')




    # git_log = "git show "+commit+ " -- " +  sstub['bugFilePath'] +" > gitshow_" + commit + ".txt"
